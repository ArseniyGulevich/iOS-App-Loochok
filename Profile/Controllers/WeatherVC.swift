...
//        control.layer.cornerRadius = Constants.inset1 / 2
...
//        weatherLabel.pin(to: self.view, Constants.inset1)
//        weatherView.pinCenterX(to: view)
//        weatherView.setWidth(150)
//        weatherView.setHeight(150)
//        weatherView.pinTop(to: view, Constants.inset1 * 4)
//    }
//
...
//        let rect = CGRect(x: Constants.inset1, y: Constants.inset1, width: view.frame.width - Constants.inset1 * 2, height: view.frame.height - Constants.inset1 * 2)
